...
<div class="product-line-grid row">
  ...
  <div class="product-line-grid-left col-md-5 col-xs-12">
    <div class="row">
      <span class="product-image media-middle col-md-4 col-xs-4">
        <img src="{$product.cover.bySize.cart_default.url}" alt="{$product.name|escape:'quotes'}">
      </span>
      <div class="product-line-grid-body col-md-8 col-xs-8">
        <div class="product-line-info">
          <a class="product_name" href="{$product.url}"
  ...
  <div class="product-line-grid-right product-line-actions col-md-7 col-xs-12">
    <div class="row">
      <div
        class="col-md-4 col-xs-12 product-price-and-shipping product-price {if $product.has_discount}has-discount{/if}">
      ...
      <div class="col-md-3 col-xs-12 qty">
      ...
      <div class="col-md-4 col-xs-12 price">
