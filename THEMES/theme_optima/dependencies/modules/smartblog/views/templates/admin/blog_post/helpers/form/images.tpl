...
<div id="product-images" class="panel product-tab">
	...
	<div class="panel-heading tab" >
		{l s='Images' d='Modules.Smartblog.Images'}
	...
	<div class="row">
		<div class="form-group">
			<label class="control-label col-lg-3 file_upload_label">
				<span class="label-tooltip" data-toggle="tooltip"
					title="{l s='Format:' d='Modules.Smartblog.Images'} JPG, GIF, PNG. {l s='Filesize:' d='Modules.Smartblog.Images'} {$max_image_size|string_format:"%.2f"} {l s='MB max.'}">
					{if isset($id_image)}{l s='Edit this product\'s image:' d='Modules.Smartblog.Images'}{else}{l s='Add a new image to this Book' d='Modules.Smartblog.Images'}{/if}
				</span>
			</label>
			<div class="col-lg-9">
				{$image_uploader}
		...
		<div class="form-group">
			<label class="control-label col-lg-3">
				<span class="label-tooltip" data-toggle="tooltip"
					title="{l s='Invalid characters:' d='Modules.Smartblog.Images'} <>;=#{}">
					{l s='Caption' d='Modules.Smartblog.Images'}
				</span>			
			</label>
			<div class="col-lg-9">
		...
		<tr id="image_id">
			...
			<td>
				<a href="#" class="delete_product_image pull-right btn btn-default" >
					<i class="icon-trash"></i> {l s='Delete this image' d='Modules.Smartblog.Images'}
				</a>
			</td>
		</tr>
	</table>
	<div class="panel-footer">
		<a href="{$link->getAdminLink('AdminBlogPost')}" class="btn btn-default"><i class="process-icon-cancel"></i> {l s='Cancel' d='Modules.Smartblog.Images'}</a>
		<button type="submit" name="submitAddBlogPost" class="btn btn-default pull-right"><i class="process-icon-save"></i> {l s='Save' d='Modules.Smartblog.Images'}</button>
		<button type="submit" name="submitAddBlogPostAndStay" class="btn btn-default pull-right"><i class="process-icon-save"></i> {l s='Save and stay' d='Modules.Smartblog.Images'}</button>
	</div>
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$('.delete_product_image').die().live('click', function(e)
			{
				...
				if (confirm("{/literal}{l s='Are you sure?' js=1 d='Modules.Smartblog.Images'}{literal}"))
				doAdminAjax({
