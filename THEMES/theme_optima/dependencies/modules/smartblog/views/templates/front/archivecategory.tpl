        ...
        <nav class="breadcrumb smart-blog-breadcrumb">
          <ol>
              ...
              <li>
                ...
                <span>{l s='All Post'  d='Modules.Smartblog.Archivecategory'}</span>
                </a>
              </li>
                {if $year}
                  <li>
                    ...
                    <span>{l s=$year  d='Modules.Smartblog.Archivecategory'}</span>
                    </a>
                  </li>
                {/if}
                {if $month}
                  <li>
                    ...
                    <span>{l s=$month_name  d='Modules.Smartblog.Archivecategory'}</span>
                    </a>
                  </li>
                {/if}
                {if $day}
                  <li>
                    ...
                    <span>{l s=$day  d='Modules.Smartblog.Archivecategory'}</span>
                    </a>
                  </li>
                {/if}
              {if $title_category != ''}
...
{block name='page_content'}
    {capture name=path}<a href="{smartblog::GetSmartBlogLink('module-smartblog-list')|escape:'htmlall':'UTF-8'}">{l s='All Blog News'  d='Modules.Smartblog.Archivecategory'}</a>
         {if $title_category != ''}
