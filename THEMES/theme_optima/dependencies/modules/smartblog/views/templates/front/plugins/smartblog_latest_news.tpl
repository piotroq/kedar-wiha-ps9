<div class="block">
    <h2 class='title_block'>{l s='Latest News'  d='Modules.Smartblog.Smartblog_latest_news'}</h2>
        ...
        {if isset($view_data) AND !empty($view_data)}
            ...
            {foreach from=$view_data item=post}
                    ...
                    <div id="sds_blog_post" class="col-xs-12 col-sm-4 col-md-3">
                        ...
                        <a href="{$smartbloglink->getSmartBlogPostLink($post.id,$post.link_rewrite)}"  class="r_more btn btn-default button button-small"><span>{l s='Read More'  d='Modules.Smartblog.Smartblog_latest_news'}<i class="icon-chevron-right right"></i></span></a>
