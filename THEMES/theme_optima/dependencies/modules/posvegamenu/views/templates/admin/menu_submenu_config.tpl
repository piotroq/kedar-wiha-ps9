<div class="panel container">
	...
	<h3><i class="icon-cog"></i> {l s='Submenu settings' mod='posvegamenu'}</h3>
	<form id="module_form" class="defaultForm form-horizontal" action="index.php?controller=AdminModules&amp;configure=posvegamenu&amp;token={Tools::getAdminTokenLite('AdminModules')|escape:'html':'UTF-8'}" method="post" enctype="multipart/form-data" novalidate="">
		<input type="hidden" name="id_posvegamenu_item" value="{$id_posvegamenu_item}" />
		<div class="panel">
			<div class="form-wrapper">
				<!-- <div class="form-group">
                    <label class="control-label col-lg-2" for="submenu_width">{l s='Submenu width' mod='posvegamenu'}</label>
                    <div class="col-lg-10">
                ...
                <div class="form-group">
	                <label class="control-label col-lg-2" for="submenu_class">{l s='Specific class' mod='posvegamenu'}</label>
	                <div class="col-lg-6">
                ...
                <div class="form-group">
                    <label class="control-label col-lg-2" for="submenu_bg">{l s='Background type' mod='posvegamenu'}</label>
                    <div class="col-lg-10">
                ...
                <div class="form-group bg-type-color {if $submenu_info.submenu_bg == 1 || $submenu_info.submenu_bg == 3}hidden{/if}">
		            <label class="control-label col-lg-2" for="submenu_bg_color">{l s='Background color' mod='posvegamenu'}</label>
		            <div class="col-lg-10">
		        ...
		        <div class="form-group bg-type-image {if $submenu_info.submenu_bg == 1 || $submenu_info.submenu_bg == 2}hidden{/if}">
                    ...
                    <div class="col-lg-10">
                        <div class="col-lg-7">
                            ...
                            <a href="filemanager/dialog.php?type=1&field_id=submenu_bg_image" class="btn btn-default iframe-column-upload"  data-input-name="submenu_bg_image" type="button">{l s='Select image' mod='posvegamenu'} <i class="icon-angle-right"></i></a>
                            {if $submenu_info.submenu_bg_image}<img src="{$submenu_info.submenu_bg_image}" style="display: block; max-width: 200px;"/>{/if}
                        </div>
                    </div>
                </div>
                <div class="form-group bg-type-image {if $submenu_info.submenu_bg == 1 || $submenu_info.submenu_bg == 2}hidden{/if}">
                    <label class="control-label col-lg-2" for="submenu_bg_repeat">{l s='Background repeat' mod='posvegamenu'}</label>
                    <div class="col-lg-10">
                ...
                <div class="form-group bg-type-image {if $submenu_info.submenu_bg == 1 || $submenu_info.submenu_bg == 2}hidden{/if}">
                    <label class="control-label col-lg-2" for="submenu_bg_position">{l s='Background position' mod='posvegamenu'}</label>
                    <div class="col-lg-10">
