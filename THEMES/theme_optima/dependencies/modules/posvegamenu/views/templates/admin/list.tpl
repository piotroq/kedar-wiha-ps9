...
<div class="panel" id="posvegamenu-config">
	...
	<form id="module_form" class="defaultForm form-horizontal" action="posvegamenu?controller=AdminModules&amp;configure=posvegamenu&amp;token={Tools::getAdminTokenLite('AdminModules')|escape:'html':'UTF-8'}" method="post" enctype="multipart/form-data" novalidate="">
		...
		<div class="form-group">
            <label class="control-label col-lg-2" for="posvegamenu_behaviour">{l s='Behaviour' mod='posvegamenu'}</label>
            <div class="col-lg-3">
                <select id="posvegamenu_behaviour" name="posvegamenu_behaviour" class="form-controll">
                    <option value="1" {if $menu_config.posvegamenu_behaviour == 1}selected="selected"{/if}>Toogle : show in homepage and hide in other pages</option>
                    <option value="2" {if $menu_config.posvegamenu_behaviour == 2}selected="selected"{/if}>Toggle : hide in all pages</option>
                    <option value="3" {if $menu_config.posvegamenu_behaviour == 3}selected="selected"{/if}>Alway show</option>
                </select>
            </div>
        </div>
		<div class="form-group">
