$(document).ready(function() {
    ...
    $('#product_autocomplete_input')
        .autocomplete(posschart_ajaxurl + '&posschart_ajaxgetproducts=1', {
            minChars: 1,
            autoFill: true,
            max: 20,
            matchContains: true,
    ...
    $('#cat_autocomplete_input')
        .autocomplete(posschart_ajaxurl + '&posschart_ajaxgetcats=1', {
            minChars: 1,
            autoFill: true,
            max: 20,
            matchContains: true,
    ...
    $('#manu_autocomplete_input')
        .autocomplete(posschart_ajaxurl + '&posschart_ajaxgetmanus=1', {
            minChars: 1,
            autoFill: true,
            max: 20,
            matchContains: true,
