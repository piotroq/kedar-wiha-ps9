		...
		<div class="panel">
			<div class="form-wrapper">
				<div class="form-group">
                    <label class="control-label col-lg-3" for="submenu_width">{l s='Submenu width' mod='posmegamenu'}</label>
                    <div class="col-lg-9">
                        ...
                        <p class="help-block">{l s='Set maxium width of submenu. You must provide px or percent suffix (example 500px or 100vw). Full width = 100vw' mod='posmegamenu'}</p>
                    </div>
                </div>
                <div class="form-group">
	                <label class="control-label col-lg-3" for="submenu_class">{l s='Specific class' mod='posmegamenu'}</label>
	                <div class="col-lg-6">
                        ...
                        <p class="help-block">{l s='Add specific class for CSS. Allow adding multiple class, separate by space. Few preset class:' mod='posmegamenu'}
                        <ul>
                        <li>{l s='submenu-center : make the submenu position in center' mod='posmegamenu'}</li>
                        </ul>
                        </p>
	                </div>
	            </div>
                <div class="form-group">
                    <label class="control-label col-lg-3" for="submenu_bg">{l s='Background type' mod='posmegamenu'}</label>
                    <div class="col-lg-9">
                ...
                <div class="form-group bg-type-color {if $submenu_info.submenu_bg == 1 || $submenu_info.submenu_bg == 3}hidden{/if}">
		            <label class="control-label col-lg-3" for="submenu_bg_color">{l s='Background color' mod='posmegamenu'}</label>
		            <div class="col-lg-9">
		        ...
		        <div class="form-group bg-type-image {if $submenu_info.submenu_bg == 1 || $submenu_info.submenu_bg == 2}hidden{/if}">
                    <label class="control-label col-lg-3" for="submenu_bg_image">{l s='Image source' mod='posmegamenu'}</label>
                    <div class="col-lg-9">
                        <div class="col-lg-7">
                ...
                <div class="form-group bg-type-image {if $submenu_info.submenu_bg == 1 || $submenu_info.submenu_bg == 2}hidden{/if}">
                    <label class="control-label col-lg-3" for="submenu_bg_repeat">{l s='Background repeat' mod='posmegamenu'}</label>
                    <div class="col-lg-9">
                ...
                <div class="form-group bg-type-image {if $submenu_info.submenu_bg == 1 || $submenu_info.submenu_bg == 2}hidden{/if}">
                    <label class="control-label col-lg-3" for="submenu_bg_position">{l s='Background position' mod='posmegamenu'}</label>
                    <div class="col-lg-9">
