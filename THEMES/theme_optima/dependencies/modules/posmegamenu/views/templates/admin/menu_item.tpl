...
<form id="module_form" class="defaultForm form-horizontal" action="posmegamenu?controller=AdminModules&amp;configure=posmegamenu&amp;token={Tools::getAdminTokenLite('AdminModules')|escape:'html':'UTF-8'}" method="post" enctype="multipart/form-data" novalidate="">
