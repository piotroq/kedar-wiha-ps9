...
<div class="pos-menu-horizontal">
	<ul class="menu-content"> 
		{foreach from=$menus item=menu name=menus}
			<li class="menu-item menu-item{$menu.id_posmegamenu_item} {$menu.item_class|escape:'html':'UTF-8'} {if $menu.submenu_type == 0 && count($menu.sub_menu) > 0}hasChild{/if} {if $menu.submenu_type == 1 && $menu.sub_menu}hasChild{/if}">
				...
				{if $menu.submenu_type == 0}
					...
					<div class="pos-sub-menu menu-dropdown {$menu.sub_menu.submenu_config.submenu_class|escape:'html':'UTF-8'}">
					<div class="pos-sub-inner">
					{foreach from=$menu.sub_menu.info_rows item= menu_row name=menu_row}
						<div class="pos-menu-row {$menu.item_class|escape:'html':'UTF-8'}">
							{if isset($menu_row.list_col) && count($menu_row.list_col) > 0}
								{foreach from=$menu_row.list_col item= menu_col name=menu_col}
									<div class="pos-menu-col {if !$menu_col.active_mobile}hidden-mobile{/if}">
										{if $menu_col.title}
