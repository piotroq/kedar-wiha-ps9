...
{	
	...
	public function installTab(){
        ...
        $tab = new Tab();
        $tab->active = 1;
        $tab->class_name = "AdminPosmegamenu";
        $tab->name = array();
	...
	public function uninstallTab(){
		$result = true;
		$id_tab = (int)Tab::getIdFromClassName('AdminPosmegamenu');
        $tab = new Tab($id_tab);
        $result = $tab->delete();
	...
	public function hookDisplayMegamenuMobile()
	{
		$id_lang = (int)$this->context->language->id;
		$id_shop = (int)Context::getContext()->shop->id;
		...
		return $this->display(__FILE__, 'posmegamenu-mobile.tpl');
	}
	...
	public function generateCss()
	{
		...
		foreach ($submenus as $key => $submenu)
		{
			...
			#mobile-megamenu .pos-menu-horizontal .menu-content  .menu-item.menu-item'.$submenus[$key]['id_posmegamenu_item'].' > a .menu-subtitle{ 
			...
			$css .= '#mobile-megamenu .pos-menu-horizontal .menu-content  .menu-item.menu-item'.$submenus[$key]['id_posmegamenu_item'].' > a .menu-subtitle:after{ 
