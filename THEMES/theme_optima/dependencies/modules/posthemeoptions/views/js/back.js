        ...
        class L {
            constructor(t) {
                E(this, "_initializingActive", !0), E(this, "_recalc", !0), E(this, "_nanopop", null), E(this, "_root", null), E(this, "_color", A()), E(this, "_lastColor", A()), E(this, "_swatchColors", []), E(this, "_setupAnimationFrame", null), E(this, "_eventListener", {
                    ...
                    cancel: [],
                    swatchselect: []
                }), this.options = t = Object.assign({ ...L.DEFAULT_OPTIONS
                }, t);
                const {
                    swatches: e,
                    components: o,
...
$(document).ready(function(){
    ...
    var productLayout = $('.pp_image');
	var current_layout= $('input[name="pp_image"]:checked').val();
	$('.pp-image').hide();
	$('.pp-image'+current_layout).show();
	
	$('input[name="pp_image"]').change(function() {
		if($(this).is(":checked")) {
        	var value = $(this).val();
            console.log(value); console.log('xxxxxxxxxx');
        	$('.pp-image').hide();
	     	$('.pp-image'+value).show();
	   };     
    });
	...
	$.each(parray, function(index, value){
		...
		pickr1.on('change', (...args) => {
		    ...
		    $('input[name="'+ value +'"]').val(hexaColor);
		  });
	})
})
...
$(document).ready(function()
{
    ...
    $.each(items, function (i, item) {
        $('[name="hook"]').prepend($('<option>', {
            value: item,
            text : item
        }));
    });

    var cateLayout = $('input[name="cp_layout"]:checked').val();
    if(cateLayout != '2'){
        $('.cp_filters').hide();
    }
    $('input[name="cp_layout"]').change(function() {
    ...
    var grid = $('input[name="p_display"]:checked').val();
    if(grid == '1' || grid == '3' || grid == '4'){
        $('.alignment').hide();
    }
    $('input[name="p_display"]').change(function() {
