<article class="poscompare-product ">
	...
	<a href="#" class="js-poscompare-remove poscompare-remove" onclick="posCompare.removeCompare({$product.id_product|intval}); return false;">{l s='Remove' mod='poscompare'}</a>
</article>