...
class PosStaticblocks extends Module implements WidgetInterface
{
    ...
    public function __construct()
    {
        ...
        $this->posStaticblockRepository = new PosStaticblockRepository(Db::getInstance(), $this->context->shop);
    }
    ...
    public function install()
    {
        ...
        return parent::install()
			...
			&& $this->registerHook('displayMapcontact') 
    ...
    public function getWidgetVariables($hookName, array $configuration)
    {
		...
		foreach ($linkBlocks as &$block) {
            $block['content'] = str_replace('/pos_ecolife/',__PS_BASE_URI__,$block['content']);
        }
        return array(
