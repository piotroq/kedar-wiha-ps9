...
{block 'przelewy24_alert_class'}js-przelewy24-order-confirmation-warning-repayment{/block}
...
{block 'przelewy24_alert_message'}
    {l s='We were unable to confirm your payment.' d='Modules.Przelewy24payment.Shop'}
{/block}
