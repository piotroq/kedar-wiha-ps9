...
class ApplePayPaymentOptionPresenter extends AbstractPaymentOptionPresenter
{
    ...
    protected function _createAdditionalInformation(PaymentOption $paymentOption, ?PaymentMethod $paymentMethod)
    {
        ...
        $paymentOption->setAdditionalInformation($this->context->smarty->fetch('module:przelewy24payment/views/templates/front/payment_apple_pay_additional_information.tpl'));
    }
