...
class BlikChargeByCodeRequest extends RequestAbstarct implements PrzelewyRequestInterface
{
    private $body;

    public function __construct(BlikChargeByCode $body)
    {
        $this->body = $body;
    }
    ...
    {
        return 'paymentMethod/blik/chargeByCode';
    }
