...
class RefundTransactionRequest extends RequestAbstarct implements PrzelewyRequestInterface
{
    /**
    ...
    public function __construct(TransactionRefund $transactionRefund)
    {
        $this->body = $transactionRefund;
    }
