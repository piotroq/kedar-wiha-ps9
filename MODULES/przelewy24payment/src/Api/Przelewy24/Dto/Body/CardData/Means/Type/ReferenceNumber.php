...
class ReferenceNumber implements PrzelewyBodyInterface
{
    ...
    public function setId(?string $id): ReferenceNumber
    {
        $this->id = $id;
    ...
    public function setSecurityCode(?string $securityCode): ReferenceNumber
    {
