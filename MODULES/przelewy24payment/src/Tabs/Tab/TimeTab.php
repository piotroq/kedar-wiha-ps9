...
class TimeTab extends AbstractTab implements TabInterface
{
    /**
     * @var FormTabFactory
     */
    ...
    public function render()
    {
        ...
        $form = $this->formTabFactory->factory($options['config'], FormTypeEnum::TIME);
        $title = $this->formTypeEnum->getTabName(FormTypeEnum::TIME);

        return $this->twig->render('@Modules/przelewy24payment/views/templates/admin/config/tabs/time.html.twig', ['form' => $form->createView(), 'title' => $title]);
    }
