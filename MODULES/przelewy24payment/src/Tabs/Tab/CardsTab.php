...
class CardsTab extends AbstractTab implements TabInterface
{
    /**
     * @var FormTabFactory
     */
    ...
    public function render()
    {
        ...
        $form = $this->formTabFactory->factory($options['config'], FormTypeEnum::CARDS);
        $title = $this->formTypeEnum->getTabName(FormTypeEnum::CARDS);

        return $this->twig->render('@Modules/przelewy24payment/views/templates/admin/config/tabs/cards.html.twig', ['form' => $form->createView(), 'title' => $title]);
    }
