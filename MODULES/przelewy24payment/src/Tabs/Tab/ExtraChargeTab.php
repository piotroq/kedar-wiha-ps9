...
class ExtraChargeTab extends AbstractTab implements TabInterface
{
    /**
     * @var FormTabFactory
     */
    ...
    public function render()
    {
        ...
        $form = $this->formTabFactory->factory($options['config'], FormTypeEnum::EXTRA_CHARGE);
        $title = $this->formTypeEnum->getTabName(FormTypeEnum::EXTRA_CHARGE);

        return $this->twig->render('@Modules/przelewy24payment/views/templates/admin/config/tabs/extra-charge.html.twig', ['form' => $form->createView(), 'title' => $title]);
    }
