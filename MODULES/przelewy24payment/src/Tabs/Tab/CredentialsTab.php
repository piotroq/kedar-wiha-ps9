...
class CredentialsTab extends AbstractTab implements TabInterface
{
    /**
     * @var FormTabFactory
     */
    ...
    public function render()
    {
        ...
        $form = $this->formTabFactory->factory($options['config'], FormTypeEnum::CREDENTIALS);
        $title = $this->formTypeEnum->getTabName(FormTypeEnum::CREDENTIALS);

        return $this->twig->render('@Modules/przelewy24payment/views/templates/admin/config/tabs/credentials.html.twig', ['form' => $form->createView(), 'title' => $title]);
    }
