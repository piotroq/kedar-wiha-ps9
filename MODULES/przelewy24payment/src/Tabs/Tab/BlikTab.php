...
class BlikTab extends AbstractTab implements TabInterface
{
    /**
     * @var FormTabFactory
     */
    ...
    public function render()
    {
        ...
        $form = $this->formTabFactory->factory($options['config'], FormTypeEnum::BLIK);
        $title = $this->formTypeEnum->getTabName(FormTypeEnum::BLIK);

        return $this->twig->render('@Modules/przelewy24payment/views/templates/admin/config/tabs/blik.html.twig', ['form' => $form->createView(), 'title' => $title]);
    }
