...
class ApplePayTab extends AbstractTab implements TabInterface
{
    /**
     * @var FormTabFactory
     */
    ...
    public function render()
    {
        ...
        $form = $this->formTabFactory->factory($options['config'], FormTypeEnum::APPLE);
        $title = $this->formTypeEnum->getTabName(FormTypeEnum::APPLE);

        return $this->twig->render('@Modules/przelewy24payment/views/templates/admin/config/tabs/apple.html.twig', ['form' => $form->createView(), 'title' => $title]);
    }
