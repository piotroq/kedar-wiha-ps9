...
class PaymentTab extends AbstractTab implements TabInterface
{
    /**
     * @var FormTabFactory
     */
    ...
    public function render()
    {
        ...
        $form = $this->formTabFactory->factory($options['config'], FormTypeEnum::PAYMENT);
        $title = $this->formTypeEnum->getTabName(FormTypeEnum::PAYMENT);

        return $this->twig->render('@Modules/przelewy24payment/views/templates/admin/config/tabs/payment.html.twig', ['form' => $form->createView(), 'title' => $title]);
    }
