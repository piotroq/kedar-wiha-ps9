...
class InstallmentsTab extends AbstractTab implements TabInterface
{
    /**
     * @var FormTabFactory
     */
    ...
    public function render()
    {
        ...
        $form = $this->formTabFactory->factory($options['config'], FormTypeEnum::INSTALLMENTS);
        $title = $this->formTypeEnum->getTabName(FormTypeEnum::INSTALLMENTS);

        return $this->twig->render('@Modules/przelewy24payment/views/templates/admin/config/tabs/installments.html.twig', ['form' => $form->createView(), 'title' => $title]);
    }
