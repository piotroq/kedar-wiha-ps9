...
class GooglePayTab extends AbstractTab implements TabInterface
{
    /**
     * @var FormTabFactory
     */
    ...
    public function render()
    {
        ...
        $form = $this->formTabFactory->factory($options['config'], FormTypeEnum::GOOGLE);
        $title = $this->formTypeEnum->getTabName(FormTypeEnum::GOOGLE);

        return $this->twig->render('@Modules/przelewy24payment/views/templates/admin/config/tabs/google.html.twig', ['form' => $form->createView(), 'title' => $title]);
    }
