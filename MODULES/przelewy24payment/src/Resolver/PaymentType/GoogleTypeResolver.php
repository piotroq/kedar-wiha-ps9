...
class GoogleTypeResolver implements PaymentTypeResolverInterface
{
    private const NAME = ['Google Pay'];
    private const GROUP = ['Credit Card', 'Google Pay'];
    private const SUBGROUP = ['Credit Card', 'Google Pay'];
    ...
    public function resolve(PaymentMethod $paymentMethod)
    {
        ...
        if (
            ...
            $paymentMethod->setType(PaymentTypeEnum::GOOGLE_PAYMENT);
        }
    }
