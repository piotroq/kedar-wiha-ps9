...
class AppleTypeResolver implements PaymentTypeResolverInterface
{
    private const NAME = ['ApplePay', 'Apple Pay'];
    private const GROUP = ['Credit Card', 'Apple Pay'];
    private const SUBGROUP = ['Credit Card', 'Apple Pay'];
    ...
    public function resolve(PaymentMethod $paymentMethod)
    {
        ...
        if (
            ...
            $paymentMethod->setType(PaymentTypeEnum::APPLE_PAYMENT);
        }
    }
