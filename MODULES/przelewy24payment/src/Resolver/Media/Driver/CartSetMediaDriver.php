...
class CartSetMediaDriver implements ControllerSetMediaDriverInterface
{
    /**
     * @var \Context
     */
    ...
    public function registerMedia(Config $config, Przelewy24Config $accountConfig)
    {
        ...
        $this->context->controller->registerJavascript(
            $this->module->name . '-cart',
            'modules/' . $this->module->name . '/views/js/front/' . ModuleConfiguration::PRZELEWY24 . '-cart.js',
            [
                'position' => 'bottom',
            ]
        );
