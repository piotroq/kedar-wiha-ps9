...
class ProductSetMediaDriver implements ControllerSetMediaDriverInterface
{
    /**
     * @var \Context
     */
    ...
    public function registerMedia(Config $config, Przelewy24Config $accountConfig)
    {
        ...
        $this->context->controller->registerJavascript(
            ...
            'modules/' . $this->module->name . '/views/js/front/' . ModuleConfiguration::PRZELEWY24 . '-product.js',
            [
                'position' => 'bottom',
            ]
        );
