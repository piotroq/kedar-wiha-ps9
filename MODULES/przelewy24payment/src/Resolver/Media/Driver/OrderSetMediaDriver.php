...
class OrderSetMediaDriver implements ControllerSetMediaDriverInterface
{
    /**
     * @var \Context
     */
    ...
    public function registerMedia(Config $config, Przelewy24Config $accountConfig)
    {
        ...
        $this->context->controller->registerJavascript(
            $this->module->name . '-order',
            'modules/' . $this->module->name . '/views/js/front/' . ModuleConfiguration::PRZELEWY24 . '-order.js',
            [
                'position' => 'bottom',
            ]
        );
