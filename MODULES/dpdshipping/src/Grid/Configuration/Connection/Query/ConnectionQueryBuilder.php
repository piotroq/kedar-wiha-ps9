...
namespace DpdShipping\Grid\Configuration\Connection\Query;
...
/**
 * Defines all required sql statements to render list.
 */
class ConnectionQueryBuilder extends AbstractDoctrineQueryBuilder
{
    /**
    ...
    public function getSearchQueryBuilder(SearchCriteriaInterface $searchCriteria): QueryBuilder
    {
        ...
        $qb
            ->select('id, id_shop, name, login, master_fid, environment, is_default');
    ...
    private function getQueryBuilder(array $filterValues): QueryBuilder
    {
        $qb = $this->connection
            ->createQueryBuilder()
            ->from($this->dbPrefix . 'dpdshipping_connection', 'sa');
