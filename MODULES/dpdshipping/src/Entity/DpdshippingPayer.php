...
/**
 * @ORM\Entity(repositoryClass=DpdshippingPayerRepository::class)
 */
class DpdshippingPayer
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\Column(name="id_connection", type="integer")
     */
    ...
    public function setIdConnection(int $idConnection): self
    {
