...
class DpdShippingParameterController extends FrameworkBundleAdminController
{
    ...
    public function index(Request $request): Response
    {
        ...
        if ($textForm->isSubmitted() && $textForm->isValid()) {
            ...
            if (empty($errors)) {
                ...
                return $this->redirectToRoute('dpdshipping_parameters_form');
            }

            $this->flashErrors($errors);
        }

        return $this->render('@Modules/dpdshipping/views/templates/admin/configuration/parameters-form.html.twig', [
