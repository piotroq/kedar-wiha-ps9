...
class GetAvailableCarrierHandler
{
    /**
    ...
    public function handle(GetAvailableCarrier $query)
    {
        $result = [];
        $carrierList = $this->repository->findBy(['active' => 1, 'idShop' => (int)Context::getContext()->shop->id]);
        ...
        foreach ($carrierList as $carrier) {
            ...
            $result[$carrier->getType()] = $carrierId;
        }
