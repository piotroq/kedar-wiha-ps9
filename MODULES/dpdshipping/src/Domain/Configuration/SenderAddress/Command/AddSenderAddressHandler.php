...
class AddSenderAddressHandler
{
    ...
    public function handle(AddSenderAddressCommand $command): bool
    {
        $this->repository->addOrUpdate($command->getSenderAddress(), $command->getIdShop());
