...
class GetShippingByOrderIdHandler
{
    /**
    ...
    public function handle(GetShippingByOrderId $query)
    {
        return $this->dpdshippingShippingHistoryRepository->getLastShippingByOrderId($query->getOrderId());
    }
}
