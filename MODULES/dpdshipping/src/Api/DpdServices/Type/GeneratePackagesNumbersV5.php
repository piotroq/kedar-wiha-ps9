...
class GeneratePackagesNumbersV5
{
    /**
     * @var OpenUMLFeV4
     */
     ...
     * Constructor
     *
     * @var OpenUMLFeV4 $openUMLFeV4
     * @var string $pkgNumsGenerationPolicyV1
     * @var string $langCode
     * @var AuthDataV1 $authDataV1
     */
    public function __construct($openUMLFeV4, $pkgNumsGenerationPolicyV1, $langCode, $authDataV1)
    {
    ...
    /**
     * @param OpenUMLFeV4 $openUMLFeV4
     * @return GeneratePackagesNumbersV5
     */
    public function withOpenUMLFeV4($openUMLFeV4)
    {
        $new = clone $this;
        $new->openUMLFeV4 = $openUMLFeV4;
