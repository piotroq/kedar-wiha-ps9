...
class PackagesPickupCallV2
{
     ...
     */
    public function __construct($dpdPickupParamsV2, $authDataV1)
    {
     ...
     * @return PackagesPickupCallV2
     */
    public function withDpdPickupParamsV2($dpdPickupParamsV2)
    {
        $new = clone $this;
        $new->dpdPickupParamsV2 = $dpdPickupParamsV2;
