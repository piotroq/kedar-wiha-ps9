...
class GeneratePackagesNumbersV9
{
     ...
     * Constructor
     *
     * @var OpenUMLFeV11 $openUMLFeV11
     * @var string $pkgNumsGenerationPolicyV1
     * @var string $langCode
     * @var AuthDataV1 $authDataV1
     */
    public function __construct($openUMLFeV11, $pkgNumsGenerationPolicyV1, $langCode, $authDataV1)
    {
    ...
    /**
     * @param OpenUMLFeV11 $openUMLFeV11
     * @return GeneratePackagesNumbersV9
     */
    public function withOpenUMLFeV11($openUMLFeV11)
    {
        $new = clone $this;
        $new->openUMLFeV11 = $openUMLFeV11;
