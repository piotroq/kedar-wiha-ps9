...
class ServicesOpenUMLFeV11
{
    ...
    /**
     * @return ServiceDPDFoodOpenUMLFeV2
     */
    ...
    /**
     * @param ServiceDPDFoodOpenUMLFeV2 $dpdFood
     * @return ServicesOpenUMLFeV11
     */
    ...
    /**
     * @return ServicePudoToSendUMLFeV1
     */
    public function getPudoToSend()
    {
        return $this->pudoToSend;
    }

    /**
     * @param ServicePudoToSendUMLFeV1 $pudoToSend
     * @return ServicesOpenUMLFeV11
     */
    public function withPudoToSend($pudoToSend)
    {
        $new = clone $this;
        $new->pudoToSend = $pudoToSend;
