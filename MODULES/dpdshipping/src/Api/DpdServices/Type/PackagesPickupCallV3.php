...
class PackagesPickupCallV3
{
     ...
     */
    public function __construct($dpdPickupParamsV3, $authDataV1)
    {
     ...
     * @return PackagesPickupCallV3
     */
    public function withDpdPickupParamsV3($dpdPickupParamsV3)
    {
        $new = clone $this;
        $new->dpdPickupParamsV3 = $dpdPickupParamsV3;
