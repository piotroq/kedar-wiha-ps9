...
class GeneratePackagesNumbersV4
{
     ...
     */
    public function __construct($openUMLFeV3, $pkgNumsGenerationPolicyV1, $langCode, $authDataV1)
    {
     ...
     */
    public function withOpenUMLFeV3($openUMLFeV3)
    {
        $new = clone $this;
        $new->openUMLFeV3 = $openUMLFeV3;
