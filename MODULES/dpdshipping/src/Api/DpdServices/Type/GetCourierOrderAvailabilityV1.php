...
class GetCourierOrderAvailabilityV1
{
     ...
     */
    public function __construct($senderPlaceV1, $authDataV1)
    {
     ...
     * @return GetCourierOrderAvailabilityV1
     */
    public function withSenderPlaceV1($senderPlaceV1)
    {
        $new = clone $this;
        $new->senderPlaceV1 = $senderPlaceV1;
