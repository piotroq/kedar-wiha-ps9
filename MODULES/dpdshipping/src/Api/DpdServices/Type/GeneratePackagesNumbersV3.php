...
class GeneratePackagesNumbersV3
{
     ...
     */
    public function __construct($openUMLFeV2, $pkgNumsGenerationPolicyV1, $langCode, $authDataV1)
    {
     ...
     * @return GeneratePackagesNumbersV3
     */
    public function withOpenUMLFeV2($openUMLFeV2)
    {
        $new = clone $this;
        $new->openUMLFeV2 = $openUMLFeV2;
