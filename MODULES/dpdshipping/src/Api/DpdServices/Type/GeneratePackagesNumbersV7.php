...
class GeneratePackagesNumbersV7
{
    /**
     * @var OpenUMLFeV8
     */
     ...
     * Constructor
     *
     * @var OpenUMLFeV8 $openUMLFeV8
     * @var string $pkgNumsGenerationPolicyV1
     * @var string $langCode
     * @var AuthDataV1 $authDataV1
     */
    public function __construct($openUMLFeV8, $pkgNumsGenerationPolicyV1, $langCode, $authDataV1)
    {
    ...
    /**
     * @param OpenUMLFeV8 $openUMLFeV8
     * @return GeneratePackagesNumbersV7
     */
    public function withOpenUMLFeV8($openUMLFeV8)
    {
        $new = clone $this;
        $new->openUMLFeV8 = $openUMLFeV8;
